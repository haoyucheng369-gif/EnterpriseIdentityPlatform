...
using EnterpriseIdentityPlatform.ApiServer.Authentication;
using EnterpriseIdentityPlatform.ApiServer.Options;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "EnterpriseIdentityPlatform API Server",
        Version = "v1"
    });
...
builder.Services
    ...
    .AddPolicyScheme(SmartBearerScheme, "Local EnterpriseIdentityPlatform or Entra ID bearer token", options =>
    {
    ...
    {
        // Local IdP token validation uses discovery/JWKS from EnterpriseIdentityPlatform.AuthServer.
